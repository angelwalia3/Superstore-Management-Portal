 ...
 * @author Pallavi
 */
public class warehouseadminlogin implements Initializable {
    ...
    private void clickEnter(ActionEvent event) {
        ...
        String sql="select * from wareadmins where Username = '"+entername+"' and Password = '"+enterpass+"'";
        ...
        conn.rs=conn.st.executeQuery(sql);
            ...
            try{
                   ...
                   n.setname(conn.rs.getString("Warehousename"));
